    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="deleted_at" mb="4">
            <FormLabel fontSize="1rem" fontWeight={600}>
              Deleted At
            </FormLabel>
            <DatePicker
              selected={formik.values?.deleted_at ? new Date(formik.values?.deleted_at) : null}
              onChange={(value: Date) => formik.setFieldValue('deleted_at', value)}
            />
          </FormControl>
